...
Guidance for AI agents (and humans) working in `mochi-go-sdk`.

## What this is

`mochi-go-sdk` is a Go service in the Console Labs / Mochi backend (runs on EKS `mochi-prod`; see Console Labs MAP.md). Module `github.com/consolelabs/mochi-go-sdk`, Go 1.20, gitflow.
